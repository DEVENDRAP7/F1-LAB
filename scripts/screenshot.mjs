...
for (const [route, name] of [['/', 'ledger'], ['/circuits', 'circuits'], ['/lines', 'lines'], ['/upcoming', 'upcoming'], ['/errors', 'errors'], ['/aero', 'aero'], ['/whatif', 'whatif'], ['/qualifying', 'qualifying'], ['/style', 'style'], ['/refusals', 'refusals']]) {
