...
for (const [route, name] of [['/ledger', 'ledger'], ['/', 'home'], ['/circuits', 'circuits'], ['/lines', 'lines'], ['/upcoming', 'upcoming'], ['/errors', 'errors'], ['/aero', 'aero'], ['/whatif', 'whatif'], ['/qualifying', 'qualifying'], ['/sprint', 'sprint'], ['/radio', 'radio'], ['/style', 'style'], ['/refusals', 'refusals']]) {
